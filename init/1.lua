...
ennemis = 	{ 
				{350,320,42,50,ennemi_image,1,10, love.graphics.newImage("img/ennemis/tir/tourelle.png"),100,40,0,70,1,1,0,0 },
				{650,475,42,50,ennemi_image,1,10, love.graphics.newImage("img/ennemis/tir/tourelle.png"),100,40,0,20,1,-1,ennemi_image[1]:getWidth(),0 }
			}
...
coordonnees_arrivee = {200,350,30,30}-- Arrivée. x,y,largeur,hauteur

poutre_fine = love.graphics.newImage("img/obstacles/poutre_fine.png")
obstacles = { 
				{ 200, 0, 5, 200, poutre_fine,math.pi/2 },
				{ 200, 200, 5, 200, poutre_fine,math.pi/2 },
				{ 195, 400, 200, 5, poutre_fine },
				{ 395, 400, 200, 5, poutre_fine }
			}
