...
ennemis = { 
				{150,480,42,50,ennemi_image,0.5,6, love.graphics.newImage("img/ennemis/tir/tourelle_double.png"),150,20,0,70,1,-1,ennemi_image[1]:getWidth(),0 }, 
				{150,480,42,50,ennemi_image,0.5,6, love.graphics.newImage("img/ennemis/tir/tourelle_double.png"),150,20,0,70,1,1,0,0 }, 
				{650,280,42,50,ennemi_image,0.5,6, love.graphics.newImage("img/ennemis/tir/tourelle_double.png"),150,20,0,70,1,-1,ennemi_image[1]:getWidth(),0 },
				{650,280,42,50,ennemi_image,0.5,6, love.graphics.newImage("img/ennemis/tir/tourelle_double.png"),150,20,0,70,1,1,0,0 },
				{100,80,42,50,ennemi_image,0.5,6, love.graphics.newImage("img/ennemis/tir/tourelle_double.png"),150,20,0,70,1,-1,ennemi_image[1]:getWidth(),0 },
				{100,80,42,50,ennemi_image,0.5,6, love.graphics.newImage("img/ennemis/tir/tourelle_double.png"),150,20,0,70,1,1,0,0 }
			}
